...
public class TC02_RegisterCamposIncompletosTest extends BaseTest {
        ...
        void registerSuccess(Method method) {
          ...
          WebElement mensajeEmailExiste=driver.findElement(By.xpath("//div[@class='message-error validation-summary-errors']/ul/li"));
          String mensajeExitoEmail=mensajeEmailExiste.getText();
          Assert.assertEquals("The specified email already exists", mensajeExitoEmail);
